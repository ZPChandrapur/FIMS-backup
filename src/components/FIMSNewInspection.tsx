...
export const FIMSNewInspection: React.FC<FIMSNewInspectionProps> = ({
  ...
  const renderInspectionForm = () => {
    ...
    if (selectedInspectionType === 'Rajya Shaishanik Prashikshan Inspection Form') {
      return (
    ...
    if (selectedInspectionType === 'High Court Order Inspection Form') {
      return (
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <div 
            onClick={() => handleInspectionTypeSelect('Rajya Shaishanik Prashikshan Inspection Form')}
         ...
         //   { key: 'form_15', title: 'Form 15 Title', subtitle: 'Form 15 Description', color: 'rose' }
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                ) : form.key === 'High Court Order Inspection Form' ? (
                  <>
